...
vertaaltabelURL <- 'rijkswaterstaat/ecotopen/Vertaaltabel_alle_systemen_v20200303_MM_zoneringsimpel.xlsx'
```
...
```{r bewaardraaitabel}
write_csv2(draaitabel1, file.path(resultdir, "draaitabel_alles_zoneringsimpel.csv"))
```
